...
/******/ 	return __webpack_require__(__webpack_require__.s = "./land_plot.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../components/pages/land_plot/check_box.scss":
/*!****************************************************!*\
  !*** ../components/pages/land_plot/check_box.scss ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "../components/pages/land_plot/index.js":
/*!**********************************************!*\
  !*** ../components/pages/land_plot/index.js ***!
  \**********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _check_box_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./check_box.scss */ "../components/pages/land_plot/check_box.scss");
/* harmony import */ var _check_box_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_check_box_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.scss */ "../components/pages/land_plot/index.scss");
...
function create_slider(slider_id) {
  ...
  var wrapper = $(slider).parents('.range_input__block');
  var type = $(wrapper).find('.range_input_min').attr('data-type');
  var min = Number($(wrapper).find('.range_input_min').attr('data-value'));
  var max = Number($(wrapper).find('.range_input_max').attr('data-value'));
  ...
  slider.noUiSlider.on('update', function (values) {
    ...
    $(wrapper).find('.value_item').text("- ".concat(val_floor, " ").concat(type)); // $('.sum_works').text(val_floor1);
  });
}

/***/ }),

/***/ "../components/pages/land_plot/index.scss":
/*!************************************************!*\
  !*** ../components/pages/land_plot/index.scss ***!
  \************************************************/
/*! no static exports found */
...
/* harmony import */ var _components_pages_land_plot_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/pages/land_plot/index */ "../components/pages/land_plot/index.js");
// script interface
