...
/******/ 	return __webpack_require__(__webpack_require__.s = "./forest.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../components/pages/forest/index.js":
/*!*******************************************!*\
  !*** ../components/pages/forest/index.js ***!
  \*******************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.scss */ "../components/pages/forest/index.scss");
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_scss__WEBPACK_IMPORTED_MODULE_0__);

$('.about_forest_navigate_item').on('click', function () {
  var video = document.getElementById('about_forest_video');
  var currTime = $(this).attr('data-time');
...
function change_navigate() {
  var all_items = $('.about_forest_navigate_item');
  var active_index = $('.about_forest_navigate_item.active').index();
  all_items.map(function (index, item) {
...
function check_video_timeline() {
  ...
  all_items.map(function (index, item) {
    var item_time = Number($(item).attr('data-time'));
...
/***/ "../components/pages/forest/index.scss":
/*!*********************************************!*\
  !*** ../components/pages/forest/index.scss ***!
  \*********************************************/
/*! no static exports found */
...
/* harmony import */ var _components_pages_forest_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/pages/forest/index */ "../components/pages/forest/index.js");
// script interface
